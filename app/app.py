...
from routes import login_bp, register_bp, homepage_bp, cart_bp, paid_orders_bp, medicinemanager_bp, product_detail_bp, receiptmanager_bp
import os
...
def check_permissions():
    roles_permissions = {
        'nhanvien': {'receiptmanager.danh_sach_hoa_don', 'receiptmanager.chi_tiet_hoa_don',
                     'medicinemanager.medicine_manager'},
